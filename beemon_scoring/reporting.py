...
def build_text_report(scores: list[ColonyScore], metadata: dict[str, object]) -> str:
    ...
    for index, score in enumerate(scores, start=1):
        ...
        lines.append(
            ...
            f"weight {feature.weight_delta_lb:+.2f} lb over {feature.days_observed:.1f} days)"
        )
...
def _natural_language_summary(score: ColonyScore) -> str:
    ...
    return (
        ...
        f"The main drivers are {driver_text}. Its weight changed {feature.weight_delta_lb:+.2f} lb "
